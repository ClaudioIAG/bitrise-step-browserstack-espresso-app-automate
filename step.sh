...
json=$( jq -n \
                ...
                --arg insec "$browserstack_accept_insecure_cert" \
                ...
                '{devices: $devices, app: $app_url, testSuite: $test_url, package: $package, class: $class, annotation: $annotation, size: $size, logs: $logs, video: $video, local: $loc , localIdentifier: $locId, insecureCert: $insec , gpsLocation: $gpsLocation, language: $language, locale: $locale, callbackURL: $callback}')
